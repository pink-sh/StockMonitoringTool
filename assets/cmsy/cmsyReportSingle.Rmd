...
**Years over which to calculate catchability** : `r max(input$CMSY_years_q)` to `r max(input$CMSY_years_q)`
...
`r if(!is.null(input$cmsy_checkbox_comparison)){paste0(

"### Advanced use","<br/>","<br/>",

"#### Biomass reference points and MSY","<br/>",

"**Biomass biological limit (Blim)** : ",input$blim,"<br/>",

"**Biomass precautionary value (Bpa)** : ",input$bpa,"<br/>",

"**Biomass maximum sustainable yield (BMSY)** : ",input$bmsy,"<br/>",

"**Biomass at 40% over the unfished level ( B40% )** : ",input$b40,"<br/>",

"**Maximum Sustainable Yield ( MSY )** : ",input$msy,"<br/>",

"**Spawning Stock Biomass at MSY ( SSBMSY )** : ",input$msyBTrigger,"<br/>","<br/>",

"#### Fishing mortality values","<br/>",

"**Fishing mortality at Maximum Sustainable Yield ( FMSY )** : ",input$fmsy,"<br/>",

"**Fishing mortality biological limit ( Flim )** : ",input$flim,"<br/>",

"**Fishing mortality precautionary value ( Fpa )** : ",input$fpa,"<br/>",

"**Fishing mortality at overfishing level ( Fofl )** : ",input$fofl,"<br/>",

"**Last known exploitation rate** : ",input$last_fs,"<br/>",
