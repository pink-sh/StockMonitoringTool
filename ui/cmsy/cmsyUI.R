          ...
          fluidRow(
            ...
            box(title = "Optional Parameters",
                ...
                box(
                  ...
                  textInput(ns("r.low"), "Lowest resilience (both the hi and low range of this parameter must be set by the user, otherwise, the range is calculated automatically from Resilience)", "NA"),
